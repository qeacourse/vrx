function spawnBox(doc, name, mass, l, w, h, materialName)
    if nargin < 7
    ...
    % transparent materials that work in Gzweb include:
    %   BlueTransparent, OrangeTransparent, YellowTransparent,
    %   BlackTransparent, DarkMagentaTransparent, GreenTransparent
    material.setTextContent(materialName);
end